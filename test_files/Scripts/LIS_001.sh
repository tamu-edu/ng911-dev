...
curl -X POST "https://lis.demo.gridgears.io?x-api-key=0fc1d6fb44de486580fbc6819eb081e7" -d '<?xml version="1.0" ?><held:locationRequest xmlns:held="urn:ietf:params:xml:ns:geopriv:held">  <held:locationType exact="false">locationURI</held:locationType>  <device xmlns="urn:ietf:params:xml:ns:geopriv:held:id">  <uri>tel:'${POINT_DID}'</uri>  </device>  </held:locationRequest>' > $LOG_FILE 2> /dev/null
...
curl -X POST "https://lis.demo.gridgears.io?x-api-key=0fc1d6fb44de486580fbc6819eb081e7" -d '<?xml version="1.0" ?><held:locationRequest xmlns:held="urn:ietf:params:xml:ns:geopriv:held">  <held:locationType exact="false">locationURI</held:locationType>  <device xmlns="urn:ietf:params:xml:ns:geopriv:held:id">  <uri>tel:'${AREA_DID}'</uri>  </device>  </held:locationRequest>' > $LOG_FILE 2> /dev/null
...
curl -X POST "https://lis.demo.gridgears.io?x-api-key=0fc1d6fb44de486580fbc6819eb081e7" -d '<?xml version="1.0" ?><held:locationRequest xmlns:held="urn:ietf:params:xml:ns:geopriv:held">  <held:locationType exact="false">locationURI</held:locationType>  <device xmlns="urn:ietf:params:xml:ns:geopriv:held:id">  <uri>tel:'${FAIL_DID}'</uri>  </device>  </held:locationRequest>' > $LOG_FILE 2> /dev/null
