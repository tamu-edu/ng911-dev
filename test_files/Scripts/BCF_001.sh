...
SIPP_RCV_XML_SCENARIO_PATH="../SIPp_scenarios/SIP_receive/SIP_INVITE_receive.xml"
SIPP_SND_XML_SCENARIO_PATH="../SIPp_scenarios/SIP_single_message/SIP_INVITE_from_OSP.xml"
#
# --------------------------------------------------------------------
