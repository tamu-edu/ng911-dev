...
def get_test_parameters(
    ...
    stimulus_src_ip, stimulus_dst_ip, sipp_scenario = get_filter_parameters(
...
def get_test_names() -> list:
    return [
        "Validate civic and geodetic locations handling by ECRF.",
    ]
...
def get_test_list(
    ...
    return [
        TestCheck(
            ...
            test_params={"stimulus_xml": xml_request, "output_xml": xml_response},
        )
    ]
