from checks.http.held_checks.checks import (
    test_if_location_response_contains_correct_location_uri,
...
def get_test_names() -> list:
    return [
        "locationResponse contains correct locationURI URL",
        "locationResponse expiration time is between 30min and 24h",
    ]
...
def get_test_list(
    ...
    http_xml_response, http_held_message_timestamp = get_test_parameters(
    ...
    return [
        TestCheck(
            ...
            test_params={"output_xml": http_xml_response},
        ),
        TestCheck(
