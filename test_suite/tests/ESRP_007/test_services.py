...
def get_test_names() -> list:
    return [
        "Validate Discrepancy Report function support",
    ]
...
def get_test_list(
    ...
    sip_invite_str, out_message_json, emergency_call_info_header = get_test_parameters(
        pcap_service, lab_config, filtering_options
    )
    return [
        TestCheck(
