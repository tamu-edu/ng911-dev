...
from tests.PS_003.checks import validate_version_int_values, validate_version_service_info
...
def get_test_parameters(pcap_service: PcapCaptureService, lab_config: LabConfig,
                        filtering_options:  list[MessageFilter], variation) -> dict or None:
...
def get_test_names() -> list:
    return [
         ...
         f"Verify if all 'versions' contain 'serviceInfo'"
    ]
