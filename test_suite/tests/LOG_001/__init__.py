...
from tests.PS_003 import get_test_list
...
def run(pcap_service: PcapCaptureService, test_config: Test, lab_config: LabConfig):
    ...
    (test_scenario.prepare_intermediate_verdicts().
     test_scenario.calculate_general_verdict().
     test_scenario.print_general_verdict())
