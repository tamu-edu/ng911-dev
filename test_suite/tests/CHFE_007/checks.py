...
from tests.CHFE_007.constants import TIMESTAMP_THRESHOLD, STANDARD_PRIMARY_CALL_TYPE
...
def validate_common_attributes(
    ...
    try:
        ...
        assert payload_data, "FAILED - Cannot find valid JWS data in the response."
...
def validate_logging_call_signaling_message(jws_data, init_timestamp, text, call_id):
    ...
    try:
        ...
        # 'protocol' is optional. But if present than it should be 'sip'.
