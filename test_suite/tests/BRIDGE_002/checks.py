...
from tests.BRIDGE_002.constants import (
...
def validate_bridge_state_response_data(sip_response):
    """
    ...
    @param sip_response: test input data including response from BRIDGE
