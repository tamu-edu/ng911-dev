...
def get_test_parameters(
    ...
    stimulus_src_ip, stimulus_dst_ip, expected_response_code, payload_path = (
    ...
    try:
        log_event_id = extract_json_data_from_http(out_message).get("logEventId", None)
...
def get_test_names() -> list:
    return [
        "Validate 201 success response code for request.",
        "Validate 201 response JSON data.",
        "Verify logEventId is a string.",
        "Validate 4xx error response code class for request.",
    ]
