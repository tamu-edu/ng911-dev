...
from tests.BCF_009.checks import validate_extra_header
...
def get_test_names() -> list:
    return ["Adding 'Supported: replaces' to SIP INVITE as B2BUA BCF"]
...
def get_test_list(
    ...
    return [
        TestCheck(
            test_name="Adding 'Supported: replaces' to SIP INVITE as B2BUA BCF",
            test_method=validate_extra_header,
            test_params={
