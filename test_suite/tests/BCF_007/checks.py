...
from tests.BCF_007.constants import STANDARD_PRIMARY_CALL_TYPE
...
def validate_common_attributes(
    ...
    try:
        ...
        assert init_timestamp, "FAILED - timestamp from SIP message not found"

        fe_timestamp = payload_data.get("timestamp", None)

        assert fe_timestamp, "FAILED - FE request is not found."
        # Test check disabled - was additional
