...
def get_test_parameters(pcap_service: PcapCaptureService, lab_config: LabConfig,
    ...
    stimulus_src_ip, stimulus_dst_ip, variation_file_path = get_filter_parameters(lab_config,filtering_options,
                                                                                  variation)
...
def get_test_names() -> list:
    return [
         f"Validate LIS location filters by distance",
         f"Validate LIS speed filters by distance",
         f"Validate LIS elements value change filters by distance",
         f"Validate LIS entering area filters by distance",
         f"Validate LIS location type filters by distance",
    ]
