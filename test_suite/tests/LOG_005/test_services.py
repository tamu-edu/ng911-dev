...
def get_test_parameters(
    ...
    if expected_response_code != "4xx":
        return out_message, response_code, expected_response_code
...
def get_test_list(
    ...
    test_response, response_code, expected_response_code = get_test_parameters(
        ...
        return [
            TestCheck(
                ...
                test_params={
                    ...
                    "additional_element": {"logEventIds": (list, dict, tuple)},
                    "array_name": "logEventIdArray",
                    "id_name": "logEventId",
                },
            )
        ]
