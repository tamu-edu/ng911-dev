...
def get_test_names() -> list:
    return [
         f"Validate sending HTTP LoST request to another ECRF",
         f"Validate sending back HTTP LoST response from another ECRF",
         f"Validate if LoST response contain URL",
    ]
