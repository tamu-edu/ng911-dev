...
from tests.CHFE_004.checks import validate_chfe_callbacks_and_outbound
...
def get_test_parameters(
    ...
    stimulus_src_ip, stimulus_dst_ip, variation_method = get_filter_parameters(
    ...
    if variation_method == "send":
        response_from_chfe = get_first_message_matching_filter(
            pcap_service,
            FilterConfig(
    ...
    return sip_invite_message, response_from_chfe, variation_method
...
def get_test_list(
    ...
    sip_invite_to_chfe, chfe_response, variation_method = get_test_parameters(
    ...
    return [
        TestCheck(
            ...
            test_method=validate_chfe_callbacks_and_outbound,
            test_params={
                "sip_invite_to_chfe": sip_invite_to_chfe,
                "chfe_response": chfe_response,
