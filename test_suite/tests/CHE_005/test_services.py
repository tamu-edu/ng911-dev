...
from tests.CHE_005.checks import validate_che_response_code, validate_che_response
...
def get_test_names() -> list:
    return [
        f"Validate CHE response for SIP INVITE",
        f"Validate CHE response code for SIP INVITE"
            ]
...
def get_test_list(pcap_service: PcapCaptureService,
    ...
    return [
        TestCheck(
            ...
            test_method=validate_che_response,
            test_params={
        ...
        TestCheck(
            test_name="Validate CHE response code for SIP INVITE",
