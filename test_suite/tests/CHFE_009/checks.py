...
def media_start_log_validation(
    ...
    Args:
        ...
        stimulus_timestamp (Any): Timestamp of the stimulus event used for validation.
...
def common_fields_validation(
    ...
    try:
        ...
        equality_check = is_test_data_the_same(
            _extract_value(stimulus_call_id), call_id, error_msg
        )
        ...
        equality_check = is_test_data_the_same(
            _extract_value(stimulus_incident_id), incident_id, error_msg
        )
        assert equality_check == "PASSED", equality_check
        assert (
