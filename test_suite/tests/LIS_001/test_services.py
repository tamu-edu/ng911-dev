from checks.sip.message_body_checks.checks import (
    test_if_xml_body_list_contains_pidf_lo_location,
)
...
def get_filter_parameters(
    ...
    for message in variation.params.get("messages"):
        ...
        scenario_file_path = (
            sipp_scenario.get("scenario_file_path") if sipp_scenario else None
        )
...
def get_test_list(
    ...
    output_message_xml_body_list, variation_name = get_test_parameters(
    ...
    return [
        TestCheck(
            ...
            test_params={"message_xml_body_list": output_message_xml_body_list},
        )
    ]
