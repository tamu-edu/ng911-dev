...
from tests.BCF_008.checks import validate_mime_integrity
...
def get_test_names() -> list:
    return ["Validate BCF forwards the same INVITE data."]
...
def get_test_list(
    ...
    return [
        TestCheck(
            test_name="Validate BCF forwards the same INVITE data.",
