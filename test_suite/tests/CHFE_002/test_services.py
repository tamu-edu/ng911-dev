        ...
        for out_message in messages_after_timestamp:
            try:
                ...
                if (out_message.sip.status_code == expected_response_code and
                    ...
                    return (out_message.sip.status_code,
...
def get_test_names() -> list:
    return [
         f"Validate SIP 200 OK response for SIP INVITE",
    ]
...
def get_test_list(pcap_service: PcapCaptureService,
    ...
    (
        response_code, expected_response_code, expected_media_attrs, actual_media_attrs
