...
from tests.ECRF_LVF_012.checks import validate_ecrf_service_urn_response
...
def get_filter_parameters(
    ...
    :return: Tuple (stimulus_src_ip, stimulus_dst_ip, expected_response_code)
    """
    stimulus = None
...
def get_test_names() -> list:
    return [
        "Validate ECRF-LVF findServiceResponse for 'urn:emergency:service' namespace"
    ]
...
def get_test_list(
    ...
    return [
        TestCheck(
            test_name="Validate ECRF-LVF findServiceResponse for 'urn:emergency:service' namespace",
            test_method=validate_ecrf_service_urn_response,
            test_params={
                "test_data": test_data,
            },
        )
