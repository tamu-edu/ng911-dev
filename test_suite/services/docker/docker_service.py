...
class DockerService:
    def __init__(self):
        ...
        self.network_names: List[Any] = []

    def ensure_network(
        self, name="stub_net", subnet="192.168.100.0/24", gateway="192.168.100.1"
    ):
    ...
    def run_container(
        ...
        connected_container_ids = [
            c["Name"] for c in network.attrs["Containers"].values()
        ]
