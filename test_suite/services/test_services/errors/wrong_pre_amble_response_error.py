class WrongPreambleResponseError(Exception):
    """
    Custom exception for handling preabmle response errors.

    Attributes:
        message (str): Description of the error.
        errors (list): List of detailed error messages.
    """
    def __init__(self, message: str = "Configuration error occurred.", errors: list = None):
        """
