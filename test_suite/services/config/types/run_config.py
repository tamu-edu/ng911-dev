...
from services.config.types.test_config import VarInterfaces, MessageFilter, Preamble, Postamble
                ...
                "tests": [
                    {
                        ...
                        "preamble_list": [
                            ...
                            } for preamble in test.preamble_list
                        ],
                        "postamble_list": [
                            {
                                "method_name": postamble.method_name,
                                "kwargs": copy.deepcopy(postamble.kwargs),
                            } for postamble in test.postamble_list
                        ]
