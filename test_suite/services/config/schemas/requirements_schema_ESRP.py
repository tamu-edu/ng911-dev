REQUIREMENTS_SCHEMA = {
    ...
    "RQ_ESRP_009": {
        ...
        "document_section": "4.2.1.3",
        "description": "Handling of Forked Requests: Forking between elements MUST NOT be used",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_010": {
        "requirement_text": "The Notifier MUST be capable of generating NOTIFYs at the maximum busy second call rate to the maximum number of downstream dequeueing entities, plus at least 10 other subscribers.",
        "document_section": "4.2.1.3",
        "description": "The Notifier MUST be capable of generating NOTIFYs at the maximum busy second call rate to the maximum number of downstream dequeueing entities, plus at least 10 other subscribers",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_011": {
    ...
    "RQ_ESRP_012": {
        "requirement_text": "However, some routes are seldom used, and a mechanism MUST be provided that ensures the connectedness of each entity remains known.",
        "document_section": "4.2.1.3",
        "description": "However, some routes are seldom used, and a mechanism MUST be provided that ensures the connectedness of each entity remains known",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_014": {
    ...
    "RQ_ESRP_087": {
        "requirement_text": "Periodic OPTIONS transactions MUST be used between ESRPs that normally pass calls between themselves, between the ESRP and the PSAPs, LNGs and LPGs it normally serves",
        "document_section": "3.1.2.3",
        "description": "Periodic OPTIONS transactions MUST be used between ESRPs that normally pass calls between themselves, between the ESRP and the PSAPs, LNGs and LPGs it normally serves",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_088": {
        "requirement_text": "The period between OPTIONS requests used for keep-alive SHOULD be provisioned, and default to one (1) minute (which MUST be less than the Transport Layer Security (TLS) timeout period) intervals during periods of inactivity.",
        "document_section": "3.1.2.3",
        "description": "The period between OPTIONS requests used for keep-alive SHOULD be provisioned, and default to one (1) minute (which MUST be less than the TLS timeout period) intervals during periods of inactivity",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_089": {
    ...
    "RQ_ESRP_092": {
        "requirement_text": 'This document uses the "emergency" Namespace Identifier (NID) for Uniform Resource Name (URN) resources.\nUse of the "nena" NID is retained for backwards compatibility when used with v2 interfaces, but v3 interfaces MUST use the "emergency" NID.\nThe lexical equivalence is the same as defined in URN Syntax (RFC 2141) [112].\nUnless otherwise specified, all FEs MUST treat these URNs as case insensitive when doing comparisons in order to follow the lexical equivalency rules of A Uniform Resource Name (URN) for Emergency and Other Well-Known Services (RFC 5031) [45].',
        "document_section": "2.1.4",
        "description": "v3 interfaces MUST use the 'emergency' NID; FEs MUST treat these URNs as case insensitive when doing comparisons",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_093": {
        "requirement_text": "Forking between elements MUST NOT be used.",
        "document_section": "2.4.1",
        "description": "Forking between elements MUST NOT be used",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_094": {
        "requirement_text": "all elements MUST be able to handle a full E.164 telephone number.",
        "document_section": "2.10",
        "description": "All elements MUST be able to handle a full E.164 telephone number",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_095": {
        "requirement_text": "SIP elements MUST conform to RFC 3824 [29]",
        "document_section": "2.10",
        "description": "SIP elements MUST conform to RFC 3824",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_096": {
        "requirement_text": 'All NG9-1-1 elements which process calls MUST implement all of the standards listed in Section 3 (Core Standards) of the "Hitchhiker\'s Guide to SIP" (RFC 5411) [9], and RFC 4320 [36].',
        "document_section": "3.1",
        "description": "All NG9-1-1 elements which process calls MUST implement all of the standards listed in Section 3 (Core Standards) of the Hitchhiker's Guide to SIP (RFC 5411), and RFC 4320",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_097": {
        "requirement_text": "Use of REGISTER is not defined in this document, so REGISTER SHALL NOT be used.",
        "document_section": "3.1.3.1",
        "description": "Use of REGISTER is not defined in this document, so REGISTER SHALL NOT be used",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_098": {
        "requirement_text": "401 (Unauthorized) MUST NOT occur for a 9-1-1 call.",
        "document_section": "3.1.4",
        "description": "401 (Unauthorized) MUST NOT occur for a 9-1-1 call",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_099": {
        "requirement_text": "Redundancy support for a SIP call MUST NOT depend on non-standard mechanisms in SIP elements. Only mechanisms such as UPDATE or re-INVITE with a modified Contact and out-of-dialog REFER, which only rely on aspects of standards this document requires of all SIP elements in the ESInet, MUST be used to perform re-home on an established SIP dialog in the case of host failure.",
        "document_section": "3.1.14",
        "description": "Redundancy support for a SIP call MUST NOT depend on non-standard mechanisms in SIP elements; only standards-based mechanisms such as UPDATE, re-INVITE with modified Contact, and out-of-dialog REFER MUST be used to re-home an established SIP dialog in the case of host failure",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_100": {
    ...
    "RQ_ESRP_132": {
        "requirement_text": "All protocol operations MUST be integrity-protected with TLS, using SHA-256 [62] or stronger.",
    ...
    "RQ_ESRP_133": {
        "requirement_text": "SHA-256 MUST be supported by all implementations.",
        "document_section": "5.7",
        "description": "SHA-256 MUST be supported by all implementations.",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_134": {
        ...
        "description": "All protocol operations MUST be privacy protected via TLS, preferably using Advanced Encryption Standard (AES) [63] with a minimum key length of 256 bits (AES-256). Shorter key length MUST NOT be used. Systems currently using Data Encryption Standard (DES) or triple-DES MUST be upgraded to at least AES-256. Alternate encryption algorithms are acceptable as long as they are at least as strong as AES.",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_137": {
    ...
    "RQ_ESRP_185": {
        ...
        "test_id": "ESRP_011",
        "subtests": ["MIME Integrity Validation"],
    },
    "RQ_ESRP_186": {
    ...
    "RQ_ESRP_209": {
        "requirement_text": "All agencies ... MUST have access to a conformant Logging Service and log all relevant events in that service.",
        "document_section": "4.12.4",
        "description": "All agencies and NG9-1-1 functional elements MUST have access to a conformant Logging Service and log all relevant events in that service",
        "test_id": "",
        "subtests": [],
    ...
    "RQ_ESRP_211": {
        ...
        "document_section": "4.2.3",
        "description": "Use of an external Policy Store MUST be possible even if an implementation includes a Policy Store",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_212": {
    ...
    "RQ_ESRP_214": {
        "requirement_text": "problem (One of the following tokens: InitialTrafficBlocked; MidTrafficBlocked; BadSDP; BadSIP; MediaLoss; TrafficNotBlockedBadActor; TrafficNotBlocked; QoS; BadCDR; TTY; Firewall; OtherBCF)",
        "document_section": "3.7.6",
        "description": "problem token: one of InitialTrafficBlocked, MidTrafficBlocked, BadSDP, BadSIP, MediaLoss, TrafficNotBlockedBadActor, TrafficNotBlocked, QoS, BadCDR, TTY, Firewall, OtherBCF",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_215": {
        "requirement_text": "sosSource (The emergency-source parameter of the dialog request (i.e., the initial INVITE))",
        "document_section": "3.7.6",
        "description": "sosSource: the emergency-source parameter of the dialog request (i.e., the initial INVITE)",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_216": {
    ...
    "RQ_ESRP_217": {
        "requirement_text": "packetHeader (For InitialTrafficBlocked, MidTrafficBlocked, TrafficNotBlockedBadActor, TrafficNotBlocked, or Firewall, contains the packet's header, encoded using base64)",
        "document_section": "3.7.6",
        "description": "packetHeader: for InitialTrafficBlocked, MidTrafficBlocked, TrafficNotBlockedBadActor, TrafficNotBlocked, or Firewall, contains the packet's header, encoded using base64",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_218": {
        "requirement_text": "Each ESRP ... MUST be provisioned with credentials suitable to present to any LIS in its service area to be able to dereference a location reference using either SIP or HELD.",
        "document_section": "4.2.1.7",
        "description": "Each ESRP MUST be provisioned with credentials suitable to present to any LIS in its service area to be able to dereference a location reference using either SIP or HELD",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_219": {
        "requirement_text": "The ESRP ... MUST be provisioned with the credentials for the ECRF.",
        "document_section": "4.2.2.3",
        "description": "The ESRP MUST be provisioned with the credentials for the ECRF",
        "test_id": "",
        "subtests": [],
    },
    "RQ_ESRP_220": {
        ...
        "document_section": "4.2.3",
        "description": "The ESRP MUST be provisioned with the policy store it uses",
        "test_id": "",
        "subtests": [],
    },
}
