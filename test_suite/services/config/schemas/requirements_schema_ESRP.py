REQUIREMENTS_SCHEMA = {
    ...
    "RQ_ESRP_024": {
        ...
        "test_id": "ESRP_003",
        "subtests": ["Keeping original 'Geolocation' header field.","Keeping original message bodies."]
    },
    "RQ_ESRP_025": {
        ...
        "test_id": "ESRP_003",
        "subtests": ["Adding default PIDF-LO.","Adding 'Geolocation' pointing to default PIDF-LO."]
    },
    "RQ_ESRP_026": {
        ...
        "test_id": "ESRP_003",
        "subtests": ["Adding default PIDF-LO.","Adding 'Geolocation' pointing to default PIDF-LO.","Adding 'Geolocation' as top-most entry in 'Geolocation' section.","Keeping original 'Geolocation' header field.","Keeping original message bodies."]
    },
    "RQ_ESRP_027": {
    ...
    "RQ_ESRP_043": {
        ...
        "test_id": "ESRP_006",
        "subtests": ["Adding 'Route' header field with queue URI received from ECRF","Added 'Route' header field contains 'lr' parameter"]
    },
    "RQ_ESRP_044": {
    ...
    "RQ_ESRP_045": {
        ...
        "test_id": "ESRP_006",
        "subtests": ["Incident Tracking Identifier URN","Incident Tracking Identifier String ID","Incident Tracking Identifier FQDN","Incident Tracking Identifier 'purpose' parameter"]
    },
    "RQ_ESRP_046": {
        ...
        "test_id": "ESRP_006",
        "subtests": ["Emergency Call Identifier URN","Emergency Call Identifier String ID","Emergency Call Identifier FQDN","Emergency Call Identifier 'purpose' parameter"]
    },
    "RQ_ESRP_047": {
