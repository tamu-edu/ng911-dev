                    ...
                    "tests": {
                        ...
                        "schema": {
                            ...
                            "requirements": {
                                ...
                                "schema": {
                                    "name": {"required": True, "type": str},
                                    "variations": {"required": True, "type": list},
                                },
                            },
                            "preamble_list": {
                                "required": False,
                                ...
                                "schema": {
                                    ...
                                    "required_for": {"required": False, "type": list},
                        ...
                        "schema": {
                            ...
                            "test_env": {
                                ...
                                "schema": {
                                    ...
                                    "log_ref": {"required": False, "type": str},
                                    "log_ret_date": {"required": False, "type": str},
                                },
                            },
                        },
                    },
                                ...
                                "schema": {
                                    "messages": {
                                        ...
                                        "schema": {
                                            ...
                                            "prompt": {"required": False, "type": str},
    ...
    "lab_config": {
        ...
        "schema": {
            ...
            "pca_certificate_key": {
                ...
                "type": str,
                "extra_checks": [
                    "if_certificate_path_valid",
                ],
            },
            "test_suite_host_ip": {
                "required": True,
                "type": str,
                "extra_checks": ["if_ip_valid", "if_test_suite_host_ip_valid"],
            },
            "entities": {
                "required": True,
                "type": list,
        ...
        "schema": {
                ...
                "schema": {
                    ...
                    "id_summary": {
                        ...
                        "schema": {
                            ...
                            "test_env": {
                                ...
                                "schema": {
                                    "ixit_id": {"required": True, "type": str},
                                    "test_method": {"required": True, "type": str},
                                    "test_period_start": {
                                        "required": True,
                                        "type": str,
                                    },
                    ...
                    "log": {
                        ...
                        "schema": {
                            "level": {"required": True, "type": str},
                            "output_file": {"required": True, "type": str},
                            "dev_mode": {"required": False, "type": bool},
                        },
                    },
                    "comments": {
                        "required": True,
            ...
            "tests": {
                ...
                "schema": {
                    ...
                    "forward_conduit_config": {"required": False, "type": str},
...
FORWARD_CONDUIT_CONFIG_SCHEMA = {
    "forward_conduits": {
        ...
        "schema": {
            "name": {"required": True, "type": str},
            "from_if": {"required": True, "type": str},
            "to_if": {"required": True, "type": str},
            "proxy_if": {"required": True, "type": str},
        },
    }
}
