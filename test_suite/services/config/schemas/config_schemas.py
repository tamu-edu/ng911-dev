    ...
    "lab_config": {
        ...
        "schema": {
            ...
            "pca_certificate_key": {
                "required": False,
                "type": str,
                "extra_checks": ["if_certificate_path_valid", ]
            },
            "test_suite_host_ip": {
                "required": True,
                "type": str,
                "extra_checks": ["if_ip_valid", ]
            },
            "entities": {
                "required": True,
                "type": list,
                "schema": {
                    ...
                    "function": {
                        "required": True,
                        "type": str,
                        "allowed": ["OSP", "BCF", "ESRP", "ECRF-LVF", "PS", "LOG", "CHFE", "BRIDGE", "LIS", "ADR"]
                    },
                    "fqdn": {
                        "required": False,
                        "type": str,
                        "nullable": True,
                        "extra_checks": ["if_fqdn_valid", ]
                    },
                    "certificate_file": {
                        "required": False,
                        "type": str,
                    ...
                    "interfaces": {
                        ...
                        "schema": {
                            ...
                            "mask": {
                                "required": True,
                                "type": str,
                                "extra_checks": ["if_subnet_mask_valid", ]
                            },
                            "gateway": {"required": False, "type": str, "nullable": True},
                            "dns": {
                                "required": False,
                                "type": list,
                                "extra_checks": ["if_dns_list_valid", ],
                                "nullable": True
                            },
                            "port_mapping": {
                                "required": True,
                                ...
                                "schema": {
                                    "protocol": {
                                        "required": True,
                                        "type": str,
                                        "extra_checks": ["if_protocol_valid", ]
                                    },
                                    "port": {
                                        "required": True,
                                        "type": int,
                                        "extra_checks": ["if_port_valid", ]
                                    },
                                    "transport_protocol": {
                                        "required": True,
                                        "type": str,
                                        "extra_checks": ["if_transport_protocol_valid", ]
                                    }
                                }
                            },
                        }
                    ...
                    "iut": {
                        ...
                        "schema": {
                            "type": {
                                "required": True,
                                "type": str,
                                "allowed": ["OSP", "BCF", "ESRP", "ECRF-LVF", "PS", "LOG", "CHFE", "BRIDGE", "LIS",
                                            "ADR"]
                            },
                            "name": {"required": True, "type": str},
                            "version": {"required": True, "type": str},
