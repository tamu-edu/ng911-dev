REQUIREMENTS_SCHEMA = {
    ...
    "RQ_ECRF-LVF_095": {
        ...
        "description": "Web Service parameters, such as for LogEvents, are conveyed as a JWS string with an acceptable 'alg' field in the Protected Header. Signed LogEvents must use a non-'none' algorithm and include the signing entity's X.509 certificate, either by value ('x5c') or by reference ('x5u' and 'x5t#256'), and unsigned LogEvents use 'alg' = 'none'",
        "test_id": "ECRF_LVF_011",
        "subtests": [],
    },
    "RQ_ECRF-LVF_096": {
