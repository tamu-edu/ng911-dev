REQUIREMENTS_SCHEMA = {
    ...
    "RQ_LIS_002": {
        "requirement_text": "If the LIS supplies location by reference, it MUST support HELD (RFC 5985) [7], HELD Dereferencing (RFC 6753) [55]",
        "document_section": "4.1",
        "description": "If the LIS provides location by reference, it must support HELD (RFC 5985), HELD Dereferencing (RFC 6753)",
        "test_id": "LIS_001",
        "subtests": []
    },
    "RQ_LIS_010": {
        ...
        "document_section": "4.1",
        "description": "If the LIS provides location by reference, it must support [..] and/or SIP Presence Event Package (RFC 3856).",
        "test_id": "LIS_001",
        "subtests": []
    },
    "RQ_LIS_003": {
        "requirement_text": "LISs supporting SIP MUST support location filters (RFC 6447)",
        "document_section": "4.1",
