REQUIREMENTS_SCHEMA = {
    ...
    "RQ_LOG_026": {
        ...
        "test_id": "LOG_003",
        "subtests": ["Validate 4xx error response code class for request"]
    },
    "RQ_LOG_028": {
    ...
    "RQ_LOG_032": {
        ...
        "test_id": "LOG_004",
        "subtests": ["Validate JSON body from HTTP 200 OK response for HTTP GET request to /LogEvents entrypoint."]
    },
    "RQ_LOG_033": {
    ...
    "RQ_LOG_036": {
        ...
        "test_id": "LOG_003",
        "subtests": ["Validate 201 success response code for request"]
    },
    "RQ_LOG_037": {
