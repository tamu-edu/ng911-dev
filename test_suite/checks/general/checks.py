...
def test_if_parameter_has_one_of_expected_values(parameter_name: str, parameter_value: str, expected_values: list):
    """
    ...
    try:
        ...
        assert parameter_value in expected_values, \
            f"FAILED -> {parameter_name} does not match one of expected values {expected_values}"
        return "PASSED"
    except AssertionError as e:
        return str(e)
