...
def test_if_geolocation_included_in_find_service(parameter_value: str, expected_value: str):
    """
    ...
    """
    try:
        assert parameter_value, "FAILED -> geolocation not found in HTTP GET message from ESRP to ECRF"
        assert expected_value, f"FAILED -> geolocation not found in initial SIP INVITE message to ESRP"
