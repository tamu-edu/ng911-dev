...
<!-- MULTIPLE TDs already exist - review & consolidate
 Existing TD(s) - TD_BCF_007 (from RQ_BCF_137 / BCF); TD_BRIDGE_004 (from RQ_BRG_101 / BRG); TD_CHFE_007 (from RQ_CHFE_319 / CHFE); TD_ESRP_010 (from RQ_ESRP_125 / ESRP); TD_LOG_007 (from RQ_LOG_054 / LOG) 
   MULTIPLE TDs already exist - review & consolidate
 Existing TD(s) - TD_BCF_007 (from RQ_BCF_138 / BCF); TD_BRIDGE_004 (from RQ_BRG_102 / BRG); TD_CHFE_007 (from RQ_CHFE_320 / CHFE); TD_ESRP_010 (from RQ_ESRP_126 / ESRP); TD_LOG_007 (from RQ_LOG_055 / LOG) -->
  <!-- MULTIPLE TDs already exist - review & consolidate
 Existing TD(s) - TD_BCF_007 (from RQ_BCF_128 / BCF); TD_BRIDGE_004 (from RQ_BRG_092 / BRG); TD_CHFE_007 (from RQ_CHFE_312 / CHFE); TD_ESRP_010 (from RQ_ESRP_116 / ESRP) -->
 <!-- MULTIPLE TDs already exist - review & consolidate
 Existing TD(s) - TD_BCF_007 (from RQ_BCF_136 / BCF); TD_BRIDGE_004 (from RQ_BRG_100 / BRG); TD_CHFE_007 (from RQ_CHFE_318 / CHFE); TD_ESRP_010 (from RQ_ESRP_124 / ESRP) -->
...
* If BRIDGE sends HTTP POST to Logging Service Test System with signed JWS body containing:
  ...
  * (optionally) zero or one "agencyAgentId" with string value
  * (optionally) zero or one "agencyPositionId" with string value
  * (optionally) zero or one "clientAssignedIdentifier" with string value
  * (optionally) zero or one "extension" with string value
  * (optionally) zero or one "ipAddressPort" with IP:PORT value
* If BRIDGE sends HTTP POST to Logging Service Test System with signed JWS body containing:
