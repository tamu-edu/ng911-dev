...
* BRIDGE accepts SDP offer from Test System CHFE (t140 media, multi-party unaware). 200 OK response should contain:
  * 'a=rtpmap:98 t140/1000'
* BRIDGE sends SIP INVITE to Test System OSP (t140 media, multi-party aware) containing in SDP body:
  * 'a=rtt-mixer' 
  * 'a=rtpmap:98 t140/1000'
...
* All RTP packets sent by BRIDGE to Test System OSP contain CSRC (Contributing Source Identifiers) with ID values
