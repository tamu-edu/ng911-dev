...
Variant 2:
- (Variation 1) Routing policy of type "NormalNextHopRoutePolicy" including a `policyQueueName`
- (Variation 2) Routing policy of type "OriginationRoutePolicy" including a `policyQueueName`
- (Variation 3) Routing policy of type "OtherRoutePolicy" including a `policyId`
- default Logging Service URL
...
Using traced packets on Wireshark verify if ESRP sent HTTP POST to Test System Logging Service (`/LogEvents` entrypoint) containing:
  ...
  * "callIdSip" should have the same value as Call-ID in the SIP INVITE from BCF, example:
  for following Call-ID header field in the SIP INVITE:
    ...
    ```
  * "recipientUri" with string value containing SIP URI of the Test System CHFE (the same as in the value of Route header field in SIP INVITE sent by the ESRP)
...
## Sequence Diagram
<!--
https://mermaid.live/edit#pako:eNp1k29v0zAQxr_Kya9ApF3-tFtroUhQsq1jrBGpQEJ5Y5JbatHYwXYGpep3x06aCrXiTRLf_e65xxd7TwpZIqFkNBrlopDimVc0FwA1V0qqd4WRSlN4ZluNueggjT9bFAV-4KxSrM6FwwEapgwveMOEgfeLW2Aa1qgNZDttsHahSy7JPqcOdO_LbJqdi6Ryy4sdZNYUXvKPq7vzgkdZVagu0cX9bXLOutiwmSdpEOQLqs6aZ61QeLVqDJeCbV-__a7i3nuFRkPjXHHUwAxoY7u0DUhloauY26zCfqytwhJ-cbMBZSfI3UqjMVxUum_qFEejOHbN7tfrFO6SNVylg3oPpZlDHEoh9H1YfYQ38PA167P90876xGTLFJZPX5br5J8mcew2-9-kHeTRQbrKrAU7xeQFhTn6tOmTfEeFfgALhcxg6QZIPFIpXhJqVIseqVHVzC3J3tXnxGywxpxQ-1ky9SMnuTjYGvtjvklZD2VKttWG0O7keaRtSit_PHKnqEJRolrIVhhCI7_TIHRPfhN6PR0HgT8PoyCKrm_mHtnZWDSOwiAKZ5NwPgujKDh45E_XMhhPg8k8mPuTcDq7CWd-5BHWGpntRDEYwpLbc_epvy7drRlsJV3m6OrwF510CxM
-->
