...
* Copy following XML scenario files to local storage:
  ```
  SIP_INVITE_from_OSP_with_EmergencyCallData_Call-Info_reference.xml
  SIP_INVITE_from_OSP_with_EmergencyCallData_PIDF-LO_reference.xml
  ```
...
Use SIPp scenario file: `SIP_INVITE_from_OSP_with_EmergencyCallData_Call-Info_reference.xml`

2. Reference URI in PIDF-LO body
Use SIPp scenario file: `SIP_INVITE_from_OSP_with_EmergencyCallData_PIDF-LO_reference.xml`
<!-- 3. Querying IS-ADR -->
...
* (TCP transport)
  ```
  sudo sipp -t t1 -sf SCENARIO_FILE IF_OSP_BCF_IPv4:5060
  ```
* (TLS transport)
  ```
  sudo sipp -t l1 -sf SCENARIO_FILE -tls_cert cacert.pem -tls_key cakey.pem IF_OSP_BCF_IPv4:5061
  ```
