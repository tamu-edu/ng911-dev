...
<!-- MULTIPLE TDs already exist - review & consolidate
 Existing TD(s) - TD_ECRF-LVF_008 (from RQ_ECRF-LVF_057 / ECRF-LVF); TD_ESRP_006 (from RQ_ESRP_112 / ESRP) -->
...
### References
* Requirements : RQ_ESRP_042, RQ_ESRP_043, RQ_ESRP_044, RQ_ESRP_045, RQ_ESRP_046, RQ_ESRP_048, RQ_ESRP_049, RQ_ESRP_112
...
* Verify LoST implement the Call and Incident ID extension:
  * emergencyCallIncidentId with Call-ID and Incident-ID should be present, for example:
    ```
     <nena:emergencyCallIncidentId
       callId="urn:emergency:uid:callid:123ABCdefg123ABCdefg123ABCdefg12:test.com"
       incidentTrackingId="urn:emergency:uid:incidentid:123ABCdefg123ABCdefg123ABCdefg12:test.com"/>
    ```
