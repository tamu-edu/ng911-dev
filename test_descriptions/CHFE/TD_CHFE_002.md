...
### Description
This test checks if all types of media are supported by CHFE:
- audio
- video
- text

### References
* Requirements : RQ_CHFE_006
* Test Case    : TC_CHFE_002
...
![image](../_assets/CHFE/TD_CHFE_002_Connectivity_Diagram.png)
...
1. Send SIP INVITE to CHFE - run following SIPp command on Test System, example:
  * (TLS transport)
    > sudo sipp -t l1 -sf SIPP_SCENARIO_FILE IF_CHFE_TS:5060
  * (TCP transport)
    > sudo sipp -t t1 -sf SIPP_SCENARIO_FILE IF_CHFE_TS:5061

2. On CHFE accept incoming call
...
![image](../_assets/CHFE/TD_CHFE_002_Sequence_Diagram.png)
