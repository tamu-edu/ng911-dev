...
2. Validate 4xx error response for request with incorrect 'limit' parameter (send string).
    ...
    ```
3. Validate 4xx error response for request with incorrect 'limit' parameter (send empty).
...
4. Validate 4xx error response for request with incorrect 'limit' parameter (send space).
...
5. Validate 4xx error response for request with incorrect 'limit' parameter (send value exceeding 64bit unsigned int).
...
6. Validate 4xx error response for request with incorrect 'limit' parameter (send negative value exceeding 64bit int).
...
7. Validate 4xx error response for request with incorrect 'start' parameter (send string).
    ...
    ```
8. Validate 4xx error response for request with incorrect 'start' parameter (send empty).
...
9. Validate 4xx error response for request with incorrect 'start' parameter (send space).
...
10. Validate 4xx error response for request with incorrect 'start' parameter (send value exceeding 64bit unsigned int).
...
11. Validate 4xx error response for request with incorrect 'start' parameter (send value less than 1).
...
30. **Validate 4xx error response for request with incorrect 'area' parameter.**
...
- 'IncidentIdArray' which is an array with:
    ...
    - each element in 'incidentIds' must be a string in correct Call Identifier format (example: `urn:emergency:uid:incidentid:a56e556d871:bcf.state.pa.us`):
