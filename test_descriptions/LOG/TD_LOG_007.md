...
<!-- MULTIPLE TDs already exist - review & consolidate
 ...
 <!-- Single TD exists - reuse for the rest of the group - TD_LOG_007 (from RQ_LOG_058 / LOG)
 Req IDs in Group - RQ_BCF_158, RQ_BRG_122, RQ_CHFE_341, RQ_LOG_058, RQ_LOG_060 -->
 <!-- Single TD exists - reuse for the rest of the group - TD_LOG_007 (from RQ_LOG_059 / LOG)
 Req IDs in Group - RQ_BCF_159, RQ_BRG_123, RQ_CHFE_342, RQ_LOG_059, RQ_LOG_061 -->
...
![image](../_assets/LOG/TD_LOG_007_Connectivity_Diagram.png)
...
![image](../_assets/LOG/TD_LOG_007_Sequence_Diagram.png)
