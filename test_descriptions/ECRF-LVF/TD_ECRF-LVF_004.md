...
* Copy following HTTP scenario files to local storage:
  ```
	...
	listServices_urn-emergency-service-sos.xml
	listServicesByLocation_urn-service-sos.xml
	listServicesByLocation_urn-emergency-service-sos.xml
  ```
