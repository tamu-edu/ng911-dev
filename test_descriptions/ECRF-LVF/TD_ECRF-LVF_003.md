...
![image](../_assets/ECRF-LVF/TD_ECRF-LVF_003_Connectivity_Diagram.png)
...
* Copy following HTTP scenario files to local storage:
  ```
	findService_polygon_covering_fully_one_and_partialy_another_boundary.xml
	findService_polygon_covering_fully_two_boundaries.xml
  ```
...
![image](../_assets/ECRF-LVF/TD_ECRF-LVF_003_Sequence_Diagram.png)


## Comments

Version:  010.3d.5.0.12
