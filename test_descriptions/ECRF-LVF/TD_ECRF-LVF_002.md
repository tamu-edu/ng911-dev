...
![image](../_assets/ECRF-LVF/TD_ECRF-LVF_002_Connectivity_Diagram.png)
...
* Copy following HTTP scenario files to local storage:
  ```
	...
	findService_geodetic_circle.xml
	findService_geodetic_ellipse.xml
	findService_geodetic_arc-band.xml
	findService_geodetic_polygon.xml
	findService_civic_address.xml
  ```
...
!![image](../_assets/ECRF-LVF/TD_ECRF-LVF_002_Sequence_Diagram.png)


## Comments

Version:  010.3d.5.1.11
