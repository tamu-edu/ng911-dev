...
from testing_tools.api import run_tests
...
def main():
    ...
    if args.command == "validate":
        ...
        print(
            generate_jws(
                payload_source=args.payload_file_path,
                cert_path=args.cert,
                key_path=args.key,
                ...
                disable_eddsa_checks=args.disable_eddsa_checks,
            )
        )
    ...
    elif args.command == "test_ag_pcap":
        run_tests(args.tests, args.report_file)
    else:
        _parser.print_help()
